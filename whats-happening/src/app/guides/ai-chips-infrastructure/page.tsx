...
const guide = evergreenGuides["ai-chips-infrastructure"];
const audit = getEvergreenGuideAudit(guide);
const url = `${SITE_URL}/guides/ai-chips-infrastructure`;

export const metadata: Metadata = {
  title: "AI Chips and Infrastructure: A Systems Guide | What's Happening",
  description: guide.description.en,
  alternates: { canonical: url },
  openGraph: { title: guide.title.en, description: guide.description.en, url, type: "article" },
};

export default async function AiChipsInfrastructureGuide() {
