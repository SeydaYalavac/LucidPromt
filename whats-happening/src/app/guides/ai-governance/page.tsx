...
const guide = evergreenGuides["ai-governance"];
const audit = getEvergreenGuideAudit(guide);
const url = `${SITE_URL}/guides/ai-governance`;

export const metadata: Metadata = {
  title: "AI Governance: From Principles to Evidence | What's Happening",
  description: guide.description.en,
  alternates: { canonical: url },
  openGraph: { title: guide.title.en, description: guide.description.en, url, type: "article" },
};

export default async function AiGovernanceGuide() {
