  ...
  return (
    <section className="w-full bg-[#0B0B0D] py-32">
      <div className="mx-auto max-w-7xl px-6">
        <h2 className="text-[clamp(40px,5vw,80px)] font-bold leading-none tracking-tighter text-white">WHAT&apos;S NEXT?</h2>
        <p className="mt-4 text-xl text-[#8B8B93]">Early signals with high novelty that have not crossed the Global Pulse threshold.</p>
