...
export function ExploreView() {
  ...
  return <div className="mx-auto min-h-screen max-w-[1440px] px-5 pb-28 pt-32 sm:px-8 sm:pt-40">
    <header className="grid gap-8 border-b border-white/[0.1] pb-10 lg:grid-cols-[1fr_auto] lg:items-end"><div><p className="font-mono text-xs uppercase tracking-[0.18em] text-white/45">Explore by category</p><h1 className="mt-4 text-[clamp(3rem,7vw,6.5rem)] font-medium leading-[0.9] tracking-[-0.065em] text-white">Research what matters.</h1></div><p className="max-w-md text-pretty text-base leading-7 text-[#A8A8AF] lg:pb-2">Browse source-backed topics with a plain explanation, the reason attention moved, and a practical next step.</p></header>
