...
import { matchesTrend, visibleDiscoveryCategories } from "@/lib/discovery";
...
export function ExploreView() {
  ...
  const trends = useMemo(() => (data?.trends || []).filter((trend) => matchesTrend(trend, "", activeCategory)), [activeCategory, data?.trends]);
